<template>
    <div class="flex flex-col gap-5 text-slate-800 mt-12">
        ...
        <NuxtLink to="#ExplorerAirbnb" id="ExplorerAirbnb">
            <button class="h-12 bg-white px-6 rounded shadow-lg hover:scale-105 duration-200">Découvrir des logements <span><img src="/svg/chevronn-up.svg" alt="" class="h-3 inline rotate-90"></span></button>
        </NuxtLink>
        </div>
    </div>
</template> 