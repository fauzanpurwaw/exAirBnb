<template>
    ...
    <Transition>
        <div class="flex h-screen w-screen absolute top-0 right-0 cursor-default" v-show="toggleSearch">
            <div class="absolute h-screen w-screen bg-black opacity-30 z-[1]" @click="toggleSearch = !toggleSearch, filterData(), keyWord = ''"></div>
            <div
                    ...
                    <label for="searchInput">
                        <div
                            ...
                            <button class="p-2 rounded-full hover:bg-rose-100 mx-1"
                                @click="toggleSearch = !toggleSearch, keyWord = ''"><img src="/svg/close.svg" alt="" class="h-5"></button>
                        </div>
                    </label>
