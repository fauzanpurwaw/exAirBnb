                ...
                <div class="flex flex-col gap-1 rounded" v-for="product in data.products" :key="product.id">
                    <div>
                        <Swiper class="groupSwiper"
                            ...
                            <SwiperSlide v-for="image in product.images">
                                <NuxtLink :to="'/detail/' + product.id">
                                    <img :src="image" alt=""
                                        class="w-full h-56 object-cover aspect-square duration-1000 rounded-lg">
                                </NuxtLink>
                            </SwiperSlide>
                        </Swiper>
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <p class="font-bold ml-1">{{ product.rating }} <span><img src="/svg/star.svg" alt=""
                                        class="h-4 mb-1 inline"></span></p>
                        </div>
